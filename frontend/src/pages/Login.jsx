...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#050506] text-white">
      ...
      {/* Main */}
      <main className="relative z-10 flex min-h-[calc(100vh-72px)] items-center justify-center px-5 py-12">
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm leading-6 text-zinc-500">
              Sign in to your RazorRecover command center.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  className="h-12 w-full rounded-lg border border-white/[0.08] bg-white/[0.025] px-4 text-sm text-white outline-none placeholder:text-zinc-700 transition focus:border-violet-500/50 focus:bg-white/[0.04]"
                />
              </div>
              ...
              <div>
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    className="text-[9px] text-zinc-600 transition hover:text-violet-400"
                  >
                    Forgot password?
                  </button>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-12 w-full rounded-lg border border-white/[0.08] bg-white/[0.025] px-4 pr-16 text-sm text-white outline-none placeholder:text-zinc-700 transition focus:border-violet-500/50 focus:bg-white/[0.04]"
                  />
              ...
              <button
                type="submit"
                disabled={loading}
                className="group flex h-12 w-full items-center justify-center gap-3 rounded-lg bg-violet-500 text-sm font-semibold text-white transition hover:bg-violet-400 disabled:cursor-not-allowed disabled:opacity-50"
              >
                {loading ? (
                  <>
          ...
          {/* Security */}
          <div className="mt-6 flex items-center justify-center gap-2 text-[9px] text-zinc-700">
